...
public class ApexSetValue extends AbstractSanitizableValue<ApexSetValue> implements DeepCloneable<ApexSetValue>, ApexIterableCollectionValue {
    ...
    private static Optional<Typeable> identifyType(@Nullable Typeable typeable) {
        ...
        final Optional<String> optSubType = TypeableUtil.getListSubType(typeable.getCanonicalType());
