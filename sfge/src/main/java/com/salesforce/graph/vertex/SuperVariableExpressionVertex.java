...
public class SuperVariableExpressionVertex extends TODO_FIX_HIERARCHY_ChainedVertex
    ...
    public String getCanonicalType() {
        // TODO: THROW USER ACTION EXCEPTION INSTEAD?
        return getParentClass()
            .orElseThrow(() -> new UnexpectedException("Vertex " + this.toMinimalString() + " must occur in a class"))
            // TODO: Can inner-class shenanigans cause this to be technically incorrect?
            //       E.g., `MyInner` instead of `MyOuter.MyInner`?
            .getSuperClassName()
            .orElseThrow(() -> new UnexpectedException("Super call in non-extension class: " + this.toMinimalString()));
    }
}
