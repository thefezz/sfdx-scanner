    ...
    private void executeRulesOnAnomalies(List<PathExpansionException> anomalies) {
        ...
        for (AbstractPathAnomalyRule rule : anomalyRules) {
            ...
            for (RuleThrowable ruleThrowable : ruleThrowables) {
                ...
                // incomplete RuleThrowables
                //       instead of violations. But if that ever changes, it may be desirable to
                // refactor this
                //       method and `executeRulesOnPaths()` to use a common method that processes
                // throwables.
                //       At the very least, an else-branch will be required here.
